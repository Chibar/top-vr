...
document.getElementById('header-logo_line-search-input').addEventListener('input', function () {
  searchInputChange(this);
});
document.getElementById('header-logo_line-search-input').addEventListener('change', function () {
  searchInputChange(this);
});
